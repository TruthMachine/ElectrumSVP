...
# ===[ REMOVE HARDWARE PLUGINS (IMPORTANT) ]===
rm -rf "$SRC_DIR/electrumsv/plugins/trezor"
rm -rf "$SRC_DIR/electrumsv/plugins/keepkey"
rm -rf "$SRC_DIR/electrumsv/plugins/ledger"
...
# ===[ MINIMAL CORE LIBS (kept for safety) ]===
